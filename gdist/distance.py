...
def distance_pygromos(conf, atom_1, atom_2, idx=0):
    """Distance calculation with PyGromosTools functionality

    Args:
        conf (Cnf): configuration object from PyGromosTools
        atom_1 (int): index atom_1
        atom_2 (int): index atom_2
        idx (int): idx is 0 based or 1 based
...
if __name__ == "__main__":
    ...
    distance = 0.0
    if (method == "pygromos"):
        distance = distance_pygromos(my_configuration, atom_1, atom_2, idx=0)
    elif (method == "naive"):
